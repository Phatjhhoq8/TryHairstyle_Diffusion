...
\usepackage{setspace}                   % Gói để cấu hình giãn dòng
\onehalfspacing                         % Giãn dòng 1.5 (chuẩn báo cáo đồ án)

% Cấu hình Mục lục với tocloft
\usepackage[titles]{tocloft}
\renewcommand{\cftdotsep}{1.5}          % Dấu chấm dày hơn (mặc định là 4.5)
\renewcommand{\cftchapleader}{\cftdotfill{\cftdotsep}}
\renewcommand{\cftchappresnum}{Chương } % Thêm chữ "Chương"
\addtolength{\cftchapnumwidth}{4em}     % Tăng khoảng cách để chữ "Chương 1" không bị đè lên tiêu đề
\renewcommand{\cftsecleader}{\cftdotfill{\cftdotsep}}
\renewcommand{\cftsubsecleader}{\cftdotfill{\cftdotsep}}
\renewcommand{\cftfigleader}{\cftdotfill{\cftdotsep}}
\renewcommand{\cfttableader}{\cftdotfill{\cftdotsep}}

% Căn bằng khoảng cách dọc giữa tất cả các hàng trong Mục lục (Sửa lỗi thưa/sát)
...
% ==========================================
\usepackage[square,numbers]{natbib}     % Quản lý tài liệu tham khảo
% \setcitestyle{super}                  % Đã bỏ superscript để dùng [1] mặc định
