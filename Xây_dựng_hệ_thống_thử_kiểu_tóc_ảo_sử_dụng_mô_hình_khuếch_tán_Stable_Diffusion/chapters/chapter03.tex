...
\begin{enumerate}
    ...
    \begin{figure}[H]
        \centering
        % \includegraphics[width=0.8\textwidth]{images/yolo_face_detect.jpg}
        \fbox{\parbox[c][5cm][c]{0.8\textwidth}{\centering \textbf{[CHÈN ẢNH VÍ DỤ YOLO PHÁT HIỆN KHUÔN MẶT VÀO YÊU CẦU NÀY]}}} % Xóa dòng fbox này khi có ảnh thật
...
\begin{figure}[H]
    \centering
    % \includegraphics[width=0.8\textwidth]{images/segformer_masking.jpg}
    \fbox{\parbox[c][5cm][c]{0.8\textwidth}{\centering \textbf{[CHÈN ẢNH VÍ DỤ SEGFORMER MASK FACE VÀ HAIR VÀO YÊU CẦU NÀY]}}} % Xóa dòng fbox này khi có ảnh thật
    \caption{Phân đoạn ngữ nghĩa vùng mặt và vùng tóc sử dụng mô hình SegFormer}
