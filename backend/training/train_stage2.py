...
class Stage2Trainer:
    ...
    def train_loop(self, num_epochs=1, batch_size=1, max_samples_per_chunk=0, target_size=(512, 512), accumulation_steps=8, resume=True, chunk_names=None, save_every_n_samples=3000):
        """
        Chunked Loading – Global Epoch Training.
...
if __name__ == "__main__":
    ...
    parser.add_argument("--save-steps", type=int, default=3000, help="Save checkpoint mỗi N samples (0=tắt mid-chunk save)")
