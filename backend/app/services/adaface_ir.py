"""
IR (Improved ResNet) Backbone for AdaFace

Simplified iResNet-100 implementation for AdaFace inference.
Based on: https://github.com/mk-minchul/AdaFace/blob/master/net.py
"""
...
def iresnet100(pretrained=False, progress=True, **kwargs):
    """Constructs a IResNet-100 model."""
